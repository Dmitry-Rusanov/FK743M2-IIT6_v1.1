Вот финальная, максимально полная версия `README.md`, которая объединяет параметры из вашего `.ioc` файла, технические детали из загруженного примера и все необходимые ссылки.
